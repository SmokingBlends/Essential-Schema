...
function add_missing_schema_to_product($markup, $product) {
    ...
    $return_policy = [
        ...
        'merchantReturnDays' => (int) ($returns_opts['days'] ?? 30),
        'returnMethod' => 'https://schema.org/ReturnByMail',
        'returnFees' => 'https://schema.org/' . ($returns_opts['fees_domestic'] ?? 'FreeReturn'),
        'refundType' => 'https://schema.org/FullRefund',
        'description' => $returns_opts['description'] ?? 'Free returns within 30 days of delivery. Items must be unused and in original packaging.',
        'url' => $returns_opts['url'] ?? home_url('/return-policy/'),
    ];
