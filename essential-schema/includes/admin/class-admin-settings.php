 ...
 * - Adds fields for organization, returns, shipping.
...
class ES_Config_Settings {
    ...
    public function register_fields(){
        ...
        $this->add_page_field('es_policy_pages', 'faq_page_id',      esc_html__('FAQ Page','essential-schema'),            esc_html__('Select your FAQ page. Schema disabled if empty.','essential-schema'));
