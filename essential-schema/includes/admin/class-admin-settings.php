...
class ES_Config_Settings {
    ...
    public function register_fields(){
        ...
        $this->add_text_field('es_org', 'address_country', esc_html__('Country','essential-schema'), esc_html__('e.g., US'));
        ...
        $this->add_select_field('es_domestic_returns', 'refund_type', esc_html__('Refund Type','essential-schema'), ['FullRefund', 'StoreCreditRefund', 'MoneyBackOrReplacement']);
        ...
        $this->add_textarea_field('es_domestic_returns', 'countries', esc_html__('Domestic Countries','essential-schema'), esc_html__('ISO codes, one per line, e.g., US','essential-schema'));
