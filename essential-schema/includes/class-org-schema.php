<?php
// File: includes/class-org-schema.php (Temporary version for LocalBusiness testing)
...
class ES_Org_Schema {
     ...
     * - Temporary: Hardcoded LocalBusiness for testing.
     */
    public function output_jsonld(): void {
        ...
        $org_type = 'LocalBusiness'; // Hardcoded for testing
        ...
        $store = [
            ...
            // Hardcoded LocalBusiness fields for testing
            'address' => [
                '@type' => 'PostalAddress',
